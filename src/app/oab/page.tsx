...
export const metadata = {
  title: "Matriz Aprovação · OAB",
  description: "Plataforma de estudos para OAB com IA preditiva. 2.624 PDFs, 17 matérias, 60+ peças. FGV banca exclusiva.",
}
    ...
    <div className="font-sans bg-paper dark:bg-ink min-h-screen">
          ...
          <div className="flex items-center justify-between h-16">
            <Link href="/" className="flex items-center gap-2.5">
              ...
              <div className="leading-none">
                ...
                <div className="font-mono text-[9px] text-ink/60 dark:text-paper/50 uppercase tracking-widest">exame de ordem</div>
              </div>
            </Link>
            ...
            <nav className="hidden md:flex items-center gap-6 text-sm font-medium text-ink/70 dark:text-paper/70">
              ...
              <Link href="/oab" className="text-ink dark:text-paper font-bold">OAB</Link>
      ...
      <div className="border-b-2 border-ink" style={{ background: COLOR, color: COLOR_TEXT }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2 flex items-center gap-2 font-mono text-xs">
          ...
          <span className="font-bold uppercase tracking-widest">exame oab</span>
        </div>
      </div>
          ...
          <div className="grid lg:grid-cols-12 gap-10 lg:gap-8 items-center">
            ...
            <div className="lg:col-span-7">
              <div className="inline-flex items-center gap-2 border-2 border-ink px-3 py-1.5 rounded-full mb-6" style={{ background: COLOR, color: COLOR_TEXT }}>
                ...
                <span className="font-mono text-[10px] sm:text-xs uppercase tracking-widest font-bold">Da 1ª fase à carteirinha.</span>
              </div>

              <h1 className="font-display font-bold text-5xl sm:text-6xl lg:text-7xl text-ink dark:text-paper leading-[0.95]">
                Sua aprovação<br />
                em <span style={{ background: COLOR, color: COLOR_TEXT, padding: '0 8px' }}>OAB</span><br />
                começa aqui.
              </h1>

              <p className="mt-7 text-lg text-ink/70 dark:text-paper/70 max-w-xl leading-relaxed">
                A FGV tem padrão. A gente conhece. Curadoria feita por advogados aprovados — 2.624 PDFs, peças treinadas e IA que prevê os temas mais cobrados.
              </p>
            ...
            <div className="lg:col-span-5">
              <div className="bg-ink text-paper rounded-2xl border-2 border-ink relative overflow-hidden">
                ...
                <div className="relative flex items-center justify-between px-5 py-3 border-b border-paper/10 bg-ink-2">
                  ...
                  <div className="font-mono text-[10px] text-paper/50">app.matrizaprova.com / oab</div>
                ...
                <div className="relative p-5 space-y-3">
                  <div className="bg-ink-2 rounded-xl p-4 border border-paper/10">
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center gap-2.5">
                        <div className="w-9 h-9 rounded-lg flex items-center justify-center font-display font-bold text-sm" style={{ background: COLOR, color: COLOR_TEXT }}>BA</div>
                        <div>
                          <div className="text-sm font-semibold text-paper leading-tight">Olá, Bruna</div>
                          <div className="font-mono text-[10px] text-paper/50">examinanda OAB</div>
                        </div>
                      </div>
                      <div className="text-right">
                        <div className="font-display font-bold text-xl stat-num leading-none" style={{ color: COLOR }}>23</div>
                    ...
                    <div className="flex items-end gap-1 h-8 mt-2">
                      ...
                      <div className="flex-1 bg-paper/15 rounded-sm mini-bar" style={{ height: '70%', animationDelay: '.25s' }}></div>
                  ...
                  <div className="rounded-xl p-4 relative overflow-hidden scan-line" style={{ background: COLOR, color: COLOR_TEXT }}>
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <div className="bg-ink font-mono text-[9px] px-2 py-0.5 rounded-full font-bold" style={{ color: COLOR }}>91% CAI</div>
                    </div>
                    <div className="font-display font-bold text-lg leading-tight mb-1">Direito Civil</div>
                    <div className="text-xs opacity-70 mb-3">Responsabilidade Civil · FGV · PDF</div>
                    <div className="flex items-center justify-between">
                      <span className="font-mono text-xs opacity-80 font-semibold">34 páginas · Prof. André Bittar</span>
                  ...
                  <div className="bg-ink-2 rounded-xl border border-paper/10 overflow-hidden">
                    ...
                    <div className="divide-y divide-paper/5">
                      {[
                        { ok: true, text: "Atos Ilícitos e Dano Moral", sub: "FGV · 41º Exame" },
                        { ok: true, text: "Responsabilidade Objetiva", sub: "FGV · 40º Exame" },
                        { ok: false, text: "Questão para revisar", sub: "FGV · revisar" },
                      ].map((q, i) => (
      ...
      <section className="border-b-2 border-ink" style={{ background: COLOR, color: COLOR_TEXT }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ["2.624", "PDFs 1ª fase · 17 disciplinas cobertas"],
            ["17", "matérias da 1ª fase · todas cobertas"],
            ["60+", "peças da 2ª fase treinadas"],
            ["FGV", "banca organizadora exclusiva"],
          ].map(([val, label], i) => (
            <div key={i}>
      ...
      <section id="trilha" className="py-20 lg:py-28 bg-paper dark:bg-ink border-b-2 border-ink dark:border-paper/10 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-14">
            <div className="max-w-2xl">
              ...
              <h2 className="mt-4 font-display font-bold text-4xl sm:text-5xl lg:text-6xl text-ink dark:text-paper leading-[1.05]">
                1ª fase. 2ª fase.<br />
                <span style={{ background: COLOR, color: COLOR_TEXT, padding: '0 8px' }}>Tudo coberto.</span>
              </h2>
            </div>
            <p className="text-ink/60 dark:text-paper/60 max-w-sm">
              Da teoria da 1ª fase às peças da 2ª. Cada disciplina tem sua trilha específica com PDFs, questões e modelos de peças.
            </p>
          </div>

          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              ["1ª Fase", "17 disciplinas · FGV", "Completa"],
              ["2ª Fase Civil", "Peças e teórico", "Maior demanda"],
              ["2ª Fase Penal", "Peças e teórico", "Tradição forte"],
              ["2ª Fase Trabalho", "Peças e teórico", "Alta procura"],
              ["2ª Fase Tributário", "Peças e teórico", "Especialização"],
              ["2ª Fase Constitucional", "Peças e teórico", "Crescente"],
            ].map(([name, desc, badge]) => (
          ...
          <div className="mt-12">
            <div className="font-mono text-xs uppercase tracking-widest text-ink/50 dark:text-paper/50 mb-3">/ banca responsável</div>
            <div className="flex flex-wrap gap-2">
              <span className="font-mono text-xs px-3 py-1.5 border border-ink/20 dark:border-paper/20 rounded-full text-ink/70 dark:text-paper/70">FGV (organizadora desde 2010)</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 lg:py-28 bg-ink text-paper border-b-2 border-ink relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mb-14">
            <span className="label-tag mb-5" style={{ color: COLOR, borderColor: `${COLOR}66` }}>◆ ia preditiva · oab</span>
            <h2 className="mt-4 font-display font-bold text-4xl sm:text-5xl lg:text-6xl text-paper leading-[1.05]">
              ...
              para a sua <span style={{ color: COLOR }}>OAB</span>.
            </h2>
            <p className="mt-6 text-lg text-paper/70 leading-relaxed">A IA não é genérica. Treinada nos padrões da FGV desde 2010. Sabe o que cai, por fase e por disciplina.</p>
          </div>

          <div className="grid md:grid-cols-3 gap-5">
            {[
              ["/ passo 01", "Análise da FGV", "A IA varre todos os exames desde 2010, identifica os temas recorrentes e calcula a probabilidade de cada assunto cair na próxima prova.",
              ...
              ["/ passo 02", "Diagnóstico de você", "Cruza seu desempenho por disciplina com o que a FGV cobra. Resultado: um mapa preciso de onde você está perdendo pontos.",
              ...
              ["/ passo 03", "Plano cirúrgico", "A IA gera seu plano diário: o que estudar hoje, qual peça treinar, quais questões resolver. Otimizado por fase.",
      ...
      <section className="py-20 lg:py-28 bg-paper-2 dark:bg-ink-2 border-b-2 border-ink dark:border-paper/10 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-14 max-w-3xl">
            <span className="label-tag text-ink dark:text-paper border-ink/20 dark:border-paper/20 mb-5">◆ quem passou na OAB</span>
            <h2 className="mt-4 font-display font-bold text-4xl sm:text-5xl lg:text-6xl text-ink dark:text-paper leading-[1.05]">
              Eles confiaram na <span style={{ background: COLOR, color: COLOR_TEXT, padding: '0 8px' }}>Matriz.</span><br />
              Hoje são <span style={{ background: COLOR, color: COLOR_TEXT, padding: '0 8px' }}>advogados.</span>
            </h2>
          </div>

          <div className="grid md:grid-cols-3 gap-5">
            {[
              { badge: "APROVADA", text: '"A FGV tem padrão. A Matriz me mostrou esse padrão. Estudei só o que a FGV cobra e passei na 1ª fase com folga."', initials: "MC", name: "Mariana Costa, 26", role: "41º Exame · 1ª fase" },
              { badge: "APROVADO", text: '"Passei 3 vezes na 1ª fase e sempre reprovava na 2ª Civil. A Matriz me deu os modelos certos de peça. Na 4ª tentativa, passei."', initials: "BS", name: "Bruno Silva, 29", role: "40º Exame · 2ª Civil" },
              { badge: "APROVADA", text: '"Fiz 1ª e 2ª fase de uma vez com a Matriz. O plano da IA era cirúrgico. Menos de 6 meses de estudo e aprovada nas duas."', initials: "LA", name: "Letícia Albuquerque, 24", role: "41º Exame · 1ª e 2ª" },
            ].map((t, i) => (
      ...
      <section className="py-20 lg:py-28 border-b-2 border-ink relative overflow-hidden" style={{ background: COLOR, color: COLOR_TEXT }}>
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h2 className="mt-5 font-display font-bold text-4xl sm:text-5xl lg:text-7xl leading-[1]">
            R$ 49,99 hoje.<br />
            Sua vaga em OAB <span style={{ background: COLOR_TEXT, color: COLOR, padding: '0 12px' }}>amanhã.</span>
          </h2>
          <p className="mt-6 text-lg opacity-80 max-w-xl mx-auto">
            Pagamento único · acesso vitalício. Acesso liberado também para Concursos, Militar e ENEM.
          </p>
      ...
      <section className="py-20 lg:py-28 bg-paper dark:bg-ink-2 border-b-2 border-ink dark:border-paper/10 relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-12">
            <span className="label-tag text-ink dark:text-paper border-ink/20 dark:border-paper/20 mb-5">◆ faq · oab</span>
            <h2 className="mt-4 font-display font-bold text-4xl sm:text-5xl lg:text-6xl text-ink dark:text-paper leading-[1.05]">
              Dúvidas sobre<br />
              <span style={{ background: COLOR, color: COLOR_TEXT, padding: '0 8px' }}>OAB.</span>
            </h2>
          </div>
          <div className="space-y-3">
            {([
              ["A Matriz cobre as duas fases?", "Sim. 1ª fase completa com as 17 disciplinas e questões da FGV. 2ª fase com modelos de peças nas 6 especialidades, comentados por advogados aprovados."],
              ["As peças da 2ª fase são corrigidas?", "Temos modelos comentados de peças aceitas pela FGV em cada especialidade, com análise dos critérios de pontuação. Não é correção individualizada, mas é o que funciona."],
            ...
            <div className="md:col-span-5">
              <Link href="/" className="flex items-center gap-2.5 mb-5">
                ...
                <div className="leading-none">
                  ...
                  <div className="font-mono text-[9px] text-paper/50 uppercase tracking-widest">exame de ordem</div>
                </div>
              </Link>
