        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-paper text-ink rounded-2xl border-2 border-ink overflow-hidden">
            ...
            <div className="bg-paper-2 px-6 lg:px-10 py-6 flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
              <Link href="/cadastro" className="cta-primary flex-1 inline-flex items-center justify-center gap-3 bg-lime text-ink font-display font-bold text-lg lg:text-xl px-7 py-5 rounded-xl border-2 border-ink">
      ...
      <section className="bg-lime border-b-2 border-ink relative overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-24 text-center">
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-4">
            <a href="#preco" className="cta-primary inline-flex items-center justify-center gap-3 bg-ink text-lime font-display font-bold text-lg px-8 py-5 rounded-xl border-2 border-ink">
              QUERO COMEÇAR AGORA
              <span className="font-mono">→</span>
            </a>
