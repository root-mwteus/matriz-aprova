...
export const metadata = {
  title: "Matriz Aprovação · ENEM · SISU · ProUni",
  description: "Plataforma de estudos para o ENEM com IA preditiva. Linguagens, Humanas, Natureza, Matemática, Redação. SISU, ProUni e FIES.",
}
    ...
    <div className="font-sans bg-paper dark:bg-ink min-h-screen">
          ...
          <div className="flex items-center justify-between h-16">
            <Link href="/" className="flex items-center gap-2.5">
              ...
              <div className="leading-none">
                ...
                <div className="font-mono text-[9px] text-ink/60 dark:text-paper/50 uppercase tracking-widest">enem · sisu · prouni</div>
              </div>
            </Link>
            ...
            <nav className="hidden md:flex items-center gap-6 text-sm font-medium text-ink/70 dark:text-paper/70">
              ...
              <Link href="/enem" className="text-ink dark:text-paper font-bold">ENEM</Link>
      ...
      <div className="border-b-2 border-ink" style={{ background: COLOR, color: COLOR_TEXT }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2 flex items-center gap-2 font-mono text-xs">
          ...
          <span className="font-bold uppercase tracking-widest">enem · sisu · prouni</span>
        </div>
      </div>
          ...
          <div className="grid lg:grid-cols-12 gap-10 lg:gap-8 items-center">
            ...
            <div className="lg:col-span-7">
              <div className="inline-flex items-center gap-2 border-2 border-ink px-3 py-1.5 rounded-full mb-6" style={{ background: COLOR, color: COLOR_TEXT }}>
                ...
                <span className="font-mono text-[10px] sm:text-xs uppercase tracking-widest font-bold">SISU, ProUni e FIES.</span>
              </div>

              <h1 className="font-display font-bold text-5xl sm:text-6xl lg:text-7xl text-ink dark:text-paper leading-[0.95]">
                Sua nota no<br />
                <span style={{ background: COLOR, color: COLOR_TEXT, padding: '0 8px' }}>ENEM</span> abre<br />
                as melhores portas.
              </h1>

              <p className="mt-7 text-lg text-ink/70 dark:text-paper/70 max-w-xl leading-relaxed">
                Linguagens, Humanas, Natureza, Matemática e Redação. A IA da Matriz analisa 10 anos de provas do INEP e mostra exatamente o que estuda quem tira 900+.
              </p>
            ...
            <div className="lg:col-span-5">
              <div className="bg-ink text-paper rounded-2xl border-2 border-ink relative overflow-hidden">
                ...
                <div className="relative flex items-center justify-between px-5 py-3 border-b border-paper/10 bg-ink-2">
                  ...
                  <div className="font-mono text-[10px] text-paper/50">app.matrizaprova.com / enem</div>
                ...
                <div className="relative p-5 space-y-3">
                  <div className="bg-ink-2 rounded-xl p-4 border border-paper/10">
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center gap-2.5">
                        <div className="w-9 h-9 rounded-lg flex items-center justify-center font-display font-bold text-sm" style={{ background: COLOR, color: COLOR_TEXT }}>PH</div>
                        <div>
                          <div className="text-sm font-semibold text-paper leading-tight">Olá, Pedro</div>
                          <div className="font-mono text-[10px] text-paper/50">vestibulando · USP</div>
                        </div>
                      </div>
                      <div className="text-right">
                        <div className="font-display font-bold text-xl stat-num leading-none" style={{ color: COLOR }}>31</div>
                        <div className="font-mono text-[9px] uppercase tracking-widest text-paper/50">dias</div>
                      </div>
                    </div>
                    <div className="flex items-end gap-1 h-8 mt-2">
                      <div className="flex-1 bg-paper/15 rounded-sm mini-bar" style={{ height: '40%', animationDelay: '.05s' }}></div>
                      <div className="flex-1 bg-paper/15 rounded-sm mini-bar" style={{ height: '65%', animationDelay: '.1s' }}></div>
                      <div className="flex-1 bg-paper/15 rounded-sm mini-bar" style={{ height: '50%', animationDelay: '.15s' }}></div>
                      <div className="flex-1 bg-paper/15 rounded-sm mini-bar" style={{ height: '80%', animationDelay: '.2s' }}></div>
                      <div className="flex-1 bg-paper/15 rounded-sm mini-bar" style={{ height: '55%', animationDelay: '.25s' }}></div>
                      <div className="flex-1 bg-paper/15 rounded-sm mini-bar" style={{ height: '90%', animationDelay: '.3s' }}></div>
                  ...
                  <div className="rounded-xl p-4 relative overflow-hidden scan-line" style={{ background: COLOR, color: COLOR_TEXT }}>
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <div className="bg-ink font-mono text-[9px] px-2 py-0.5 rounded-full font-bold" style={{ color: COLOR }}>78% CAI</div>
                    </div>
                    <div className="font-display font-bold text-lg leading-tight mb-1">Ciências da Natureza</div>
                    <div className="text-xs opacity-70 mb-3">Química Orgânica · Reações · INEP · PDF</div>
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2 font-mono text-xs opacity-80">
                        ...
                        <span className="font-semibold">26 páginas · Prof. Carla Bittencourt</span>
                      </div>
                  ...
                  <div className="bg-ink-2 rounded-xl border border-paper/10 overflow-hidden">
                    <div className="flex items-center justify-between px-4 py-2.5 border-b border-paper/10">
                      ...
                      <div className="font-mono text-[10px] stat-num" style={{ color: COLOR }}>81% acerto</div>
                    </div>
                    <div className="divide-y divide-paper/5">
                      {[
                        { ok: true, text: "Funções Orgânicas · Nomenclatura", sub: "INEP · 2023", time: "00:58" },
                        { ok: true, text: "Termodinâmica · 1ª Lei", sub: "INEP · 2022", time: "01:14" },
                        { ok: false, text: "Questão para revisar", sub: "INEP · revisar", time: "02:33" },
                      ].map((q) => (
      ...
      <section className="border-b-2 border-ink" style={{ background: COLOR, color: COLOR_TEXT }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ["1.739", "PDFs organizados por área e competência"],
            ["5", "áreas do ENEM com trilhas completas"],
            ["12", "simulados completos com gabarito comentado"],
            ["990+", "redações nota máxima com análise detalhada"],
          ].map(([val, label], i) => (
            <div key={i}>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-14">
            ...
            <p className="text-ink/60 dark:text-paper/60 max-w-sm">
              Cada área do ENEM tem sua trilha própria: PDFs, questões e simulados já alinhados com as competências e habilidades cobradas pelo INEP.
            </p>
          </div>

          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              ["Linguagens & Códigos", "45 questões · Língua Portuguesa, Lit. e Inglês/Espanhol", "45 questões"],
              ["Ciências Humanas", "45 questões · História, Geografia, Filosofia e Sociologia", "45 questões"],
              ["Ciências da Natureza", "45 questões · Física, Química e Biologia", "45 questões"],
              ["Matemática", "45 questões · Álgebra, Geometria, Probabilidade e Estatística", "45 questões"],
              ["Redação", "Tema surpresa · Estrutura, repertório e proposta de intervenção", "1000 pts"],
              ["SISU + ProUni + FIES", "Simulador de cortes, bolsas e financiamentos por nota", "Anual"],
            ].map(([name, desc, badge]) => (
          ...
          <div className="mt-12">
            <div className="font-mono text-xs uppercase tracking-widest text-ink/50 dark:text-paper/50 mb-3">/ banca organizadora</div>
            <div className="flex flex-wrap gap-2">
              {["INEP (Instituto Nacional de Estudos e Pesquisas Educacionais)"].map((b) => (
      ...
      <section className="py-20 lg:py-28 bg-ink text-paper border-b-2 border-ink relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mb-14">
            <span className="label-tag mb-5" style={{ color: COLOR, borderColor: `${COLOR}66` }}>◆ ia preditiva · enem</span>
            <h2 className="mt-4 font-display font-bold text-4xl sm:text-5xl lg:text-6xl text-paper leading-[1.05]">
              ...
              para o seu <span style={{ color: COLOR }}>ENEM</span>.
            </h2>
            <p className="mt-6 text-lg text-paper/70 leading-relaxed">
              A IA não é genérica. Ela analisa 10 anos de provas do INEP, mapeia as competências e habilidades mais cobradas e te diz onde estão seus pontos perdidos.
            </p>
          </div>

          <div className="grid md:grid-cols-3 gap-5">
            {[
              ["/ passo 01", "Análise do INEP", "A IA varre 10 anos de provas do ENEM, identifica os padrões de cobrança por área e calcula a probabilidade de cada tema cair.",
              ...
              ["/ passo 02", "Diagnóstico de você", "Cruza seu desempenho em cada competência com o que o INEP cobra. Resultado: um mapa de onde você está perdendo pontos e nota.",
              ...
              ["/ passo 03", "Plano para 900+", "A IA gera seu plano diário: o que estudar hoje, quantas questões resolver, qual PDF baixar. Otimizado para a sua meta de nota.",
      ...
      <section className="py-20 lg:py-28 bg-paper-2 dark:bg-ink-2 border-b-2 border-ink dark:border-paper/10 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-14 max-w-3xl">
            <span className="label-tag text-ink dark:text-paper border-ink/20 dark:border-paper/20 mb-5">◆ quem passou no ENEM com a Matriz</span>
            <h2 className="mt-4 font-display font-bold text-4xl sm:text-5xl lg:text-6xl text-ink dark:text-paper leading-[1.05]">
              Eles confiaram na <span style={{ background: COLOR, color: COLOR_TEXT, padding: '0 8px' }}>Matriz.</span><br />
              Hoje estão na <span style={{ background: COLOR, color: COLOR_TEXT, padding: '0 8px' }}>universidade.</span>
            </h2>
          </div>

          <div className="grid md:grid-cols-3 gap-5">
            {[
              { badge: "925 pts", text: '"Estudei 8 meses para medicina. A IA me mostrou que eu perdia 30 pontos em Química por negligenciar termodinâmica. Corrigi em 3 semanas. Passei na USP."', initials: "PH", name: "Pedro Henrique, 18", role: "USP · Medicina · SISU 2025" },
              { badge: "960 Redação", text: '"Tirei 540 na redação no primeiro ENEM. A Matriz analisou meus textos e apontou que eu não tinha proposta de intervenção completa. No segundo ano fui a 960."', initials: "AC", name: "Ana Caroline, 19", role: "UFRJ · Direito · SISU 2025" },
              { badge: "910 pts", text: '"Trabalhava de dia e estudava à noite. A IA montava meu plano de 1h30 por dia, priorizando o que mais caía. Passei na UFMG pela primeira vez que tentei com a Matriz."', initials: "VR", name: "Vinícius Rocha, 20", role: "UFMG · Engenharia · SISU 2024" },
            ].map((t, i) => (
      ...
      <section className="py-20 lg:py-28 border-b-2 border-ink relative overflow-hidden" style={{ background: COLOR, color: COLOR_TEXT }}>
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h2 className="mt-5 font-display font-bold text-4xl sm:text-5xl lg:text-7xl leading-[1]">
            R$ 49,99 hoje.<br />
            Sua vaga no <span style={{ background: COLOR_TEXT, color: COLOR, padding: '0 12px' }}>SISU</span> amanhã.
          </h2>
          <p className="mt-6 text-lg opacity-80 max-w-xl mx-auto">
            Pagamento único · acesso vitalício. Acesso liberado também para Concursos, OAB e Militar.
          </p>
      ...
      <section className="py-20 lg:py-28 bg-paper dark:bg-ink-2 border-b-2 border-ink dark:border-paper/10 relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-12">
            <span className="label-tag text-ink dark:text-paper border-ink/20 dark:border-paper/20 mb-5">◆ faq · enem</span>
            <h2 className="mt-4 font-display font-bold text-4xl sm:text-5xl lg:text-6xl text-ink dark:text-paper leading-[1.05]">
              Dúvidas sobre<br />
              <span style={{ background: COLOR, color: COLOR_TEXT, padding: '0 8px' }}>ENEM.</span>
            </h2>
          </div>
          <div className="space-y-3">
            {([
              ["A Matriz cobre as 5 provas do ENEM?", "Sim. Linguagens & Códigos, Ciências Humanas, Ciências da Natureza, Matemática e Redação — cada área tem trilha própria com PDFs, questões e simulados alinhados às matrizes do INEP."],
              ["A redação tem correção?", "Sim. Você envia seu texto e a IA avalia nas 5 competências do INEP: norma culta, compreensão do tema, organização, argumentação e proposta de intervenção. Cada item recebe pontuação e feedback específico."],
              ["Tem simulado completo?", "Sim. 12 simulados com as 4 provas objetivas e proposta de redação, todos com gabarito comentado e análise de desempenho por competência."],
            ...
            <div className="md:col-span-5">
              <Link href="/" className="flex items-center gap-2.5 mb-5">
                ...
                <div className="leading-none">
                  ...
                  <div className="font-mono text-[9px] text-paper/50 uppercase tracking-widest">enem · sisu · prouni</div>
                </div>
              </Link>
              <p className="text-sm leading-relaxed max-w-md">Plataforma brasileira de estudos com IA preditiva para ENEM, Concursos, OAB e Militar.</p>
            </div>
